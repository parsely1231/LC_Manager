...
class ExcelModel:
    ...
    def write_table(self, table: DataTable, y, x):
        ...
        self.ws.cell(final_row, x+self.ELEMENT_POS['補正Area%'], table.edited_total_area)

    def write_imp_data(self, data: ImpurityData, y, x):
        """worksheetにimp一つ分のデータを書き込む
        TODO excludedピークの場合、セルに色をつける機能を追加"""
